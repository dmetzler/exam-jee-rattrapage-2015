package org.isen.jee.exam.mastermind.harness;
...
import org.isen.jee.exam.mastermind.MasterMindServlet;
...
public class JettyHarness {
    ...
    protected static final String SERVLET_PATH = "/game";
    ...
    public static void startServer() throws Exception {
        ...
        context.addServlet(new ServletHolder((Servlet) new MasterMindServlet()),
                SERVLET_PATH);
